            ...
            public void onClick(View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(EditDataActivity.this, "Data berhasil diubah.", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(EditDataActivity.this, MainActivity.class));
                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(EditDataActivity.this, "Data gagal diubah.", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
